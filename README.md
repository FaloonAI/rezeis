...
<p align="center">
  <a href="https://github.com/dizzzable/rezeis/releases/latest"><img src="https://img.shields.io/badge/version-0.9.5.35-blue" alt="Version" /></a>
...
docker pull ghcr.io/dizzzable/rezeis:v0.9.5.35
```

Доступные теги: `latest` (актуальный main), `v0.9.5.35` (тег релиза), плюс `sha-<short>` для каждого коммита в `main`. Прод-`docker-compose.yml` использует `latest`.
